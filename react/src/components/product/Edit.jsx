          ...
          <form method="post" onSubmit={edit} encType="multipart/form-data">
            <div className="row">
              ...
              <div className="form-group col-md-6 col-lg-4">
                ...
                <select id="product_brand_id" name="brand_id" className="form-control form-control-sm" onChange={onChange} value={product.brand_id || '' } required>
                  <option></option>
              ...
              <div className="form-group col-md-6 col-lg-4">
                ...
                <input type="file" accept="image/*" id="product_image" name="image" className="form-control form-control-sm" maxLength="50" />
                <a href={`http://localhost:8000/storage/products/${product.image || '' }`} target="_blank" rel="noreferrer" title={`${product.image || '' }`}><img className="img-item" src={`http://localhost:8000/storage/products/${product.image || '' }`} /></a>
