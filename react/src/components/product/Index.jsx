            ...
            <table className="table table-sm table-striped table-hover">
              ...
              <tbody>
                ...
                <tr key={index}>
                  ...
                  <td className="d-none d-md-table-cell text-center">{ product.image && <a href={`http://localhost:8000/storage/products/${product.image}`} target="_blank" rel="noreferrer" title={`${product.image}`}><img className="img-list" src={`http://localhost:8000/storage/products/${product.image}`} /></a> }</td>
                  <td>{product.name}</td>
                  <td className="d-none d-md-table-cell text-right">{product.price}</td>
                  <td className="d-none d-md-table-cell">{product.brand_name}</td>
                  <td className="d-none d-md-table-cell">{product.user_account_name}</td>
                  <td className="text-center">
                    ...
                    <a className="btn btn-sm btn-danger" href="#!" onClick={(e)=> deleteItem(e, product.id)} title="Delete"><i className="fa fa-times"></i></a>
                  </td>
                </tr>
                )}
              </tbody>
